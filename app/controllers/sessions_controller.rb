class SessionsController < ApplicationController
  ...
  def create
    response = Faraday.post "https://github.com/login/oauth/access_token", {client_id: ENV["GCLIENT_ID"], client_secret: ENV["CLIENT_SECRET"],code: params[:code]}, {'Accept' => 'application/json'}
