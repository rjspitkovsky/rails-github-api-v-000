class SessionsController < ApplicationController
  ...
  def create
    resp = Faraday.post "https://github.com/login/oauth/access_token", {client_id: ENV["CLIENT_ID"], client_secret: ENV["CLIENT_SECRET"], code: params[:code]}, :headers => {'Accept' => 'application/json'}
